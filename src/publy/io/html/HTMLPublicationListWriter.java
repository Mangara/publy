/*
 * Copyright 2013-2022 Sander Verdonschot <sander.verdonschot at gmail.com>.
 *
...
public class HTMLPublicationListWriter extends PublicationListWriter {
    ...
    private void writePostamble(List<Section> sections, BufferedWriter out) throws IOException {
        ...
        out.write("    <p>Generated by <a href=\"https://github.com/Mangara/publy\">Publy " + Constants.MAJOR_VERSION + "." + Constants.MINOR_VERSION + "</a>.&nbsp;&nbsp;Last modified on " + (new SimpleDateFormat("d MMMM yyyy")).format(new Date()) + ".</p>");
        out.newLine();
